...
export default function OtherProjects() {
    return(
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4">
            ...
            <Card href="https://www.upwork.com/freelancers/~01f1aad6eae6cda2b1" headerText={"Upwork"} contentText={"I am 5 star rated on Upwork! Check out my Upwork profile and contact me there."}></Card>
        </div>
        </>
    )
}